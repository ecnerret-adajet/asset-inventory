           ...
           <input name="image" type="file" class="filestyle" data-iconName="glyphicon glyphicon-inbox" data-buttonName="btn-primary">
             ...
             <hr/>
                     ...
                     <div class="form-group{{ $errors->has('trasfer_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                        <!-- set the default data to laptop -->
                        {!! Form::select('own_list', $owns, 3, ['id' => 'myField', 'class' => 'form-control', 'placeholder' => '-- Select Asset Type --']) !!}
                        ...
                        <div class="col-md-6">
                        {!! Form::text('model', $laptop->model, ['class' => 'form-control']) !!} 
                        @if ($errors->has('model'))
                        <span class="help-block">
                        ...
                        <div class="col-md-6">
                        {!! Form::text('serial_number', $laptop->serial, ['class' => 'form-control']) !!} 
                        ...
                        <div class="col-md-6">
                        {!! Form::text('it_code', $laptop->it_code, ['class' => 'form-control']) !!} 
                        ...
                        <div class="col-md-6">
                        {!! Form::text('finance_code', $laptop->finance_code,  ['class' => 'form-control']) !!} 
