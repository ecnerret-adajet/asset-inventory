...
<head>
    ...
    <style>
        ...
        .login_bg{
         background: url('../public/img/web/inventory-bg.jpg') no-repeat center center fixed;  
 ...
 <body>
    ...
    <div class="row">
        <div class="col-md-4 no-float" style="padding: 100px 50px 50px 50px;">
            ...
            <img class="img-responsive" src="{{asset('img/web/warehouse.png')}}" style=" display: inline-block; height: 50px; width: auto;">
            Asset Inventory
            </span>
